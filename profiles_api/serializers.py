...
class UserProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'email', 'name', 'password')  # either make accessible in our API or you want to use to create new
    ...
    def create(self, validated_data):
        ...
        user = models.UserProfile.objects.create_user(        # to create and return a new user from our user profiles model manager
